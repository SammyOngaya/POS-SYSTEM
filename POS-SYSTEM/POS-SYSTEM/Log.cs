...
namespace POS_SYSTEM
{
    public partial class Log : Form
    {
        ...
        public Log(string databaseString)
        {
            InitializeComponent();
        ...
        public void logExcel()
        {
            ...
            try
            {
                ...
                ExcelLibrary.DataSetHelper.CreateWorkbook("C:\\POS\\Reports\\log.xls", ds);

                MessageBox.Show("Report generated successfully...............!", "SYSTEM LOG REPORT", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Process sts = System.Diagnostics.Process.Start("C:\\POS\\Reports\\log.xls");
                sts.WaitForExit();
        ...
        public void logPdf()
        {
            ...
            PdfWriter PW = PdfWriter.GetInstance(doc, new FileStream("C:\\POS\\Reports\\log.pdf", FileMode.Create));
            ...
            System.Diagnostics.Process.Start("C:\\POS\\Reports\\log.pdf");
