...
namespace POS_SYSTEM
{
    ...
    {
        public ViewStaff(string databaseString)
        {
            InitializeComponent(); 
        ...
        public void staffPdf()
        {
            try
            {
                ...
                PdfWriter PW = PdfWriter.GetInstance(doc, new FileStream("C:\\POS\\Reports\\Staff pdf", FileMode.Create));
                ...
                System.Diagnostics.Process.Start("C:\\POS\\Reports\\Staff pdf");
        ...
        public void staffExcel()
        {
            ...
            try
            {
                ...
                ExcelLibrary.DataSetHelper.CreateWorkbook("C:\\POS\\Reports\\Staff.xls", ds);

                MessageBox.Show("Staff report generated successfully...............!", "EMPLOYEE REPORT GENERATION ", MessageBoxButtons.OK, MessageBoxIcon.Information);
                Process sts = System.Diagnostics.Process.Start("C:\\POS\\Reports\\Staff.xls");
                sts.WaitForExit();
